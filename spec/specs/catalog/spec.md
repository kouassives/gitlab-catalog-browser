...
WHEN the user executes `gitlab-ci-cli catalog list --org to-be-continuous`
...
WHEN the user executes `gitlab-ci-cli catalog list --org to-be-continuous --json`
...
WHEN the user executes `gitlab-ci-cli catalog list --org empty-org`
...
WHEN the user executes `gitlab-ci-cli catalog list --org nonexistent-org`
...
WHEN the user executes `gitlab-ci-cli catalog list --org large-org`
...
WHEN the user executes `gitlab-ci-cli catalog search "docker build"`
...
WHEN the user executes `gitlab-ci-cli catalog search "test" --page 2 --per-page 10`
...
WHEN the user executes `gitlab-ci-cli catalog search "zzzznonexistent"`
...
WHEN the user executes `gitlab-ci-cli catalog info to-be-continuous/docker-build`
...
WHEN the user executes `gitlab-ci-cli catalog info nonexistent/component`
...
| `gitlab-ci-cli catalog list --org <namespace> --json` | List components as JSON |
| `gitlab-ci-cli catalog search <query>` | Search components by keyword |
| `gitlab-ci-cli catalog search <query> --page <n> --per-page <n>` | Search with pagination |
